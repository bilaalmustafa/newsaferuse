...
class AdminAllDonationContainer extends StatelessWidget {
  final DonationModel model;
  const AdminAllDonationContainer({super.key, required this.model});
                    ...
                    children: [
                      Expanded(
                        ...
                        child: SizedBox(
                          ...
                          height: 15.h,
                          child: Image.network(model.donationImg!,fit: BoxFit.cover,),
                        ),
                      ),
                              ...
                              IconButton(onPressed: (){
                                ...
                                showDialog(context: context, builder: (context){
                                  return DeleteDialog(onYes: (){
                                    sl<AdminController>().deleteDonationController(context, model);
                                    Navigator.of(context).pop();
                                  }, description: 'Do you want to delete the Donation');
                                });
