...
import 'package:clinics_app/features/user/lacewatch/lacewatch_homeScreen.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                              ...
                              onTap: () async {
                                ...
                                if (!await location.serviceEnabled()) {
                                  ...
                                  await controller
                                      ...
                                      .whenComplete(() {
                                    print(
                                        'kjshdfjkshajfkhsak ${pos.latitude}, ${pos.longitude}');
                                    EasyLoading.dismiss();
                                    Get.to(SearchScreen());
                                  });
                                }
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      'Bervely heels , LA',
                                      style:
                                          GoogleFonts.dmSans(fontSize: 16.sp),
                                    ),
                                    SizedBox(
                                      width: 2.w,
                                    ),
                      ...
                      HomeTabCustomClipReact(
                        img: ConstImg.homeTabFromContainer,
                        onPressed: () =>
                            sl<HomeController>().setUserHomeTabIndex(1),
                      ),
                      SizedBox(
                        height: 2.h,
                      ),
                      ...
                      SizedBox(
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return HomeTabGridViewContainer(
                                image: mdl.image,
                                title: mdl.title,
                                text: mdl.text,
                                onPressed: () {
                      ...
                      Obx(() => controller.isQuoteLoaded.value
                          ? HomeTabQuoteContainer(
                              quotesModel: controller.singleQuote!,
                            )
                      ...
                      Obx(() => controller.isQuoteLoaded.value
                          ? HomeTabDonationContainer(
                              onPressed: () =>
                                  sl<HomeController>().setUserHomeTabIndex(2),
                              model: controller.singleDonation!,
                            )
                          : const SizedBox.shrink()),
                      SizedBox(
                        height: 2.h,
